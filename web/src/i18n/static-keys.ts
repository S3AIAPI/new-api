...
// These cover dynamic labels that are passed into t at runtime.
export const STATIC_I18N_KEYS = [
  ...
  'Connect to Meshy2API 3D generation services',
  'Connect to UnrealSpeech text-to-speech services',
  'Connect to Agnes multimodal model services',
] as const
