...
func DisableChannel(channelError types.ChannelError, reason string) {
	...
	if success {
		...
		NotifyRootUserChannelStatus(formatNotifyType(channelError.ChannelId, common.ChannelStatusAutoDisabled), subject, content)
	}
}
...
func EnableChannel(channelId int, usingKey string, channelName string) {
	...
	if success {
		...
		NotifyRootUserChannelStatus(formatNotifyType(channelId, common.ChannelStatusEnabled), subject, content)
	}
}
